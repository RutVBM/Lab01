                    ...
                    <ul class="nav nav-treeview" style="margin-left: 15px;">
                        ...
                        <li class="nav-item">
                            <a href="banco.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Perfiles</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview" style="margin-left: 15px;">
                        <li class="nav-item">
                            <a href="planes_entrenamiento.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Planes de Entrenamiento</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="captacion_clientes.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Captación de clientes</p>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="reportes_gestion.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Reportes de gestión</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview" style="margin-left: 15px;">
                        ...
                        <li class="nav-item">
                            <a href="venta.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Comprobantes de venta</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="reserva_entrenamientos.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Reserva de Entrenamientos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="pagos_planes.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Pagos y Planes</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="historico_sanciones.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Histórico de Sanciones</p>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview" style="margin-left: 15px;">
                        <li class="nav-item">
                            <a href="operacion1.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Operación 1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="operacion2.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Operación 2</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview" style="margin-left: 15px;">
                        <li class="nav-item">
                            <a href="logistica1.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Logística 1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="logistica2.php" class="nav-link" style="color: white;">
                                <i class="far fa-circle nav-icon"></i><p>Logística 2</p>
                            </a>
                        </li>
                    </ul>
                </li>
